# @devtea2026/aut-nostrum-quod-voluptates
...
- [@devtea2026/aut-nostrum-quod-voluptates](#@devtea2026/aut-nostrum-quod-voluptates)
...
```js
import copy from '@devtea2026/aut-nostrum-quod-voluptates';
...
```js
import { copyStrict } from '@devtea2026/aut-nostrum-quod-voluptates';
...
```js
import { createCopier } from '@devtea2026/aut-nostrum-quod-voluptates';
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@devtea2026/aut-nostrum-quod-voluptates**      | **5,880,312**       |
| lodash.cloneDeep   | 2,706,261           |
| clone              | 2,207,231           |
| deepclone          | 1,274,810           |
| fast-clone         | 1,239,952           |
| ramda              | 1,146,152           |
| @devtea2026/aut-nostrum-quod-voluptates (strict) | 852,382             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@devtea2026/aut-nostrum-quod-voluptates**      | **162,858**         |
| ramda              | 142,104             |
| deepclone          | 133,607             |
| fast-clone         | 101,143             |
| clone              | 70,872              |
| @devtea2026/aut-nostrum-quod-voluptates (strict) | 62,961              |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@devtea2026/aut-nostrum-quod-voluptates**      | **303**             |
| fast-clone         | 245                 |
| deepclone          | 151                 |
| lodash.cloneDeep   | 150                 |
| clone              | 93                  |
| @devtea2026/aut-nostrum-quod-voluptates (strict) | 90                  |
| ramda              | 42                  |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@devtea2026/aut-nostrum-quod-voluptates**      | **2,420,466**       |
| deepclone          | 1,386,896           |
| ramda              | 1,024,108           |
| lodash.cloneDeep   | 989,796             |
| clone              | 987,721             |
| @devtea2026/aut-nostrum-quod-voluptates (strict) | 617,602             |
...
|                    | Operations / second |
| ------------------ | ------------------- |
| **@devtea2026/aut-nostrum-quod-voluptates**      | **152,792**         |
| clone              | 74,347              |
| fast-clone         | 66,576              |
| lodash.cloneDeep   | 64,760              |
| ramda              | 53,542              |
| deepclone          | 28,823              |
| @devtea2026/aut-nostrum-quod-voluptates (strict) | 21,362              |
